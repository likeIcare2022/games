...
var Storage={};Storage.VERSION=1;Storage.PATH_VERSION='com.martinmagni.monstertracks/version';Storage.PREFIX='com.martinmagni.monstertracks/data/';Storage.LEGACY_PREFIX='/';Storage.stringToHex=function(str){var hex='';for(var i=0;i<str.length;i++){hex+=str.charCodeAt(i).toString(16)+" ";}
return hex;}
...
function pokiSendLevelData(){navigator.sendBeacon('./patch/null.json?https://leveldata.poki.io/fancade-60851784770864E1','cd4e3ec1-58d1-4c37-8b4a-ba3defb8f317');}
